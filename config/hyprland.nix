    ...
    extraConfig =
      ...
      concatStrings [
        ''
          ...
          windowrulev2 = size 20% 45%, title:(1Password)
          windowrulev2 = center, title:(1Password)
          # windowrulev2 = fullscreenstate 0 2, class:^(GeForce NOW)$
          windowrulev2 = fullscreenstate 0 2, class:^(chromium-browser)$
          ...
          bind = ${modifier},DELETE,killactive,
          bind = ${modifier},BACKSPACE,exec,1password
          ...
          bind = ${modifier}SHIFT,ENTER,togglespecialworkspace
